    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ marginTop: 25, alignSelf: "center" }}>
                <Text style={{ color: "gray", fontSize: 12, fontStyle: "italic", marginBottom: 5 }}>Télécharger un Justificatif de domicile de moins de 3 mois</Text>
...
export default EditerProofOfAdress